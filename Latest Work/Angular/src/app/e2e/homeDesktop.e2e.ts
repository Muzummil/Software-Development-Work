...
describe('App Desktop screen', () => {
  ...
  let  emailId = "johndoedesktop20@mailinator.com";
  ...
  beforeEach(async () => {
     ...
     */
    it('Sign up Required fields Desktop  ', async () => {
     ...
     */
    it('Sign up Successful Desktop  ', async () => {
     ...
     */
    it('Sign up Email Taken Desktop  ', async () => {
    ...
    it('LinkedIn Login is present on Desktop  ', async () => {
        let elmt = await element(by.className('linkedInSignup')).isPresent();
        expect(elmt).toBe(true); // Passes
    });


    it('Google Login is present on Desktop  ', async () => {
