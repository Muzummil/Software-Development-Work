export class File {
    ...
    // size of the image that is prodoced after crop .
    // If the dimensions are bigger than the original a propotional
    ...
    constructor(name: string, mode: string = 'edu', file_type_names: string,
                file_size: number, file_size_unit: string, file_default: boolean = false,
                file_title: string = null) {
        this.name = name;
