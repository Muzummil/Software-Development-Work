...
@Component({
    ...
    styleUrls: ['./signUpFormJobseeker.scss']
})

export class SignupFormJobseekerComponent implements OnInit, OnDestroy {
    ...
    public errorMessage;
    public currLan = 'en';
    public titleIndex = "join_jobseeker";
    ...
    constructor(public signupService: SignupService,
        ...
        this.accountService.setPageSeo('signup-jobseeker');
