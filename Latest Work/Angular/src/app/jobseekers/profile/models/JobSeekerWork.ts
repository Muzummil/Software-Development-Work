...
export class JobSeekerWork {
    ...
    work_file_D: File = new File(this.workExpCertificateName, 'exp', 'Doc, PDF', 4, 'MB');
    work_file_M: File = new File(this.workExpCertificateName, 'exp', 'Doc, PDF', 4, 'MB');

    constructor( public workExpCertificateName = 'Work Exp Certificate') {
