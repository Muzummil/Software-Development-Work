...
export class JobSeekerEducation {
    ...
    edu_file_D: File = new File(this.educationTitle, 'edu', 'Doc, PDF', 4, 'MB');
    edu_file_M: File = new File(this.educationTitle, 'edu', 'Doc, PDF', 4, 'MB');

    constructor(public educationTitle = 'Education Certificate') {
