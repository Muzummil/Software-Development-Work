...
@Component({
  selector: 'page-edit-maintenance-request',
  templateUrl: 'edit-maintenance-request.html',
})
export class EditMaintenanceRequestPage {
  ...
  updateRequest(){
    if(this.onRequest.valid) {
      ...
      this.requestsService.updateMaintenanceRequest(this.onRequest.value,this.requestData['id']).subscribe(res=>{
